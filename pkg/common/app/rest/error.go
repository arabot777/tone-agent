...
// some copy from zauthenticator/zauthenticator/exceptions.py.
var (
...
// APIError represents an detailed error in Zhihu standard API output format.
...
func RenderError(w http.ResponseWriter, err error) {
	...
	default:
		...
		RenderJSON(w, NewDefaultAPIError(500, 5000, "StatusInternalServerError", err.Error()))
	}
}
...
// NewErrorFromTemplate create a new APIError from the provided template with the new msg.
...
func NewAPIError(statusCode int,
	errorCode int,
	kind, message string,
	data *interface{},
	debugMessage *string,
...
func NewResourceNotAvailableException(
	message string,
	data *interface{},
	debugMessage *string,
) *APIError {
